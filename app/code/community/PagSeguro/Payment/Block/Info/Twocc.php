 ...
 */
class PagSeguro_Payment_Block_Info_Twocc extends Mage_Payment_Block_Info
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('pagseguropayment/info/two_cc.phtml');
     ...
     * @return string
     */
    public function getCcNumber($number)
    {
     ...
     * @return string[]
     */
    public function getCardsPrefix()
    {
